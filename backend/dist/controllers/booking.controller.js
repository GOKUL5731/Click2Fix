...
exports.complete = exports.liveLocation = exports.history = exports.createBooking = void 0;
const error_1 = require("../middleware/error");
const bookingService = __importStar(require("../services/booking.service"));
exports.createBooking = (0, error_1.asyncHandler)(async (req, res) => {
    if (!req.auth?.sub) {
...
exports.history = (0, error_1.asyncHandler)(async (req, res) => {
...
exports.liveLocation = (0, error_1.asyncHandler)(async (req, res) => {
    res.json(await bookingService.getLiveLocation(String(req.query.bookingId)));
});
exports.complete = (0, error_1.asyncHandler)(async (req, res) => {
