...
final userRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/ai-result', builder: (_, __) => const AiDetectionResultScreen()),
    GoRoute(path: '/workers', builder: (_, __) => const WorkerComparisonScreen()),
    GoRoute(path: '/worker-detail', builder: (_, __) => const WorkerDetailScreen()),
