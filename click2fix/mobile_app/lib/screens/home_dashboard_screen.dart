        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(child: _QuickAction(icon: Icons.photo_library_outlined, label: 'Gallery', onTap: () => context.go('/upload'))),
                  const SizedBox(width: 10),
                  Expanded(child: _QuickAction(icon: Icons.videocam_outlined, label: 'Video', onTap: () => context.go('/upload'))),
                  const SizedBox(width: 10),
                  Expanded(child: _QuickAction(icon: Icons.edit_note, label: 'Type', onTap: () => context.go('/upload'))),
                  const SizedBox(width: 10),
                  Expanded(child: _QuickAction(icon: Icons.mic_outlined, label: 'Voice', onTap: () => context.go('/upload'))),
                ],
              ),
