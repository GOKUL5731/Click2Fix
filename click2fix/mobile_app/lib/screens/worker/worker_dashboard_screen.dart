...
class WorkerDashboardScreen extends ConsumerWidget {
    ...
    return Scaffold(
      body: SingleChildScrollView(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(padding: const EdgeInsets.symmetric(horizontal: 20), child: Container(
          ...
          decoration: BoxDecoration(color: AppColors.successGreen.withAlpha(15), borderRadius: BorderRadius.circular(14), border: Border.all(color: AppColors.successGreen.withAlpha(40))),
          child: Row(children: [
        ...
        const SizedBox(height: 24),
        Padding(padding: const EdgeInsets.symmetric(horizontal: 20), child: Text('New Requests', style: Theme.of(context).textTheme.headlineSmall)),
        ...
        ..._requests.map((r) => Padding(
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 12),
              Row(children: [
                Icon(Icons.location_on, size: 14, color: AppColors.textHint), const SizedBox(width: 4),
                Text(r.distance, style: Theme.of(context).textTheme.labelSmall?.copyWith(color: AppColors.textHint)),
                const SizedBox(width: 14),
                Icon(Icons.currency_rupee, size: 14, color: AppColors.textHint), const SizedBox(width: 4),
                Text(r.priceRange, style: Theme.of(context).textTheme.labelSmall?.copyWith(color: AppColors.textHint)),
                const Spacer(),
                SizedBox(height: 34, child: FilledButton(onPressed: () => context.go('/worker/quote'), child: const Text('Send Quote', style: TextStyle(fontSize: 12)))),
              ]),
            ]),
          ),
        )),
  ...
  static final _requests = [
    (title: 'Kitchen Pipe Leaking', location: 'T. Nagar, Chennai', distance: '2.4 km', priceRange: '₹300–500', urgency: 'High', urgencyColor: AppColors.emergencyRed, icon: Icons.plumbing),
    (title: 'Fan Not Working', location: 'Anna Nagar, Chennai', distance: '3.8 km', priceRange: '₹200–400', urgency: 'Medium', urgencyColor: AppColors.trustGold, icon: Icons.electrical_services),
    (title: 'Door Hinge Broken', location: 'Adyar, Chennai', distance: '5.1 km', priceRange: '₹150–300', urgency: 'Low', urgencyColor: AppColors.successGreen, icon: Icons.carpenter),
  ];
}
...
class _Btn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(onTap: onTap, child: Container(
    width: 40, height: 40, decoration: BoxDecoration(color: Colors.white.withAlpha(25), borderRadius: BorderRadius.circular(12)),
