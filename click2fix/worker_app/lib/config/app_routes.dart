...
final workerRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/registration', builder: (_, __) => const WorkerRegistrationScreen()),
    ...
    GoRoute(path: '/requests', builder: (_, __) => const NearbyRequestsScreen()),
    ...
    GoRoute(path: '/availability', builder: (_, __) => const AvailabilityToggleScreen()),
