...
class PushNotificationService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      FirebaseMessaging.onMessage.listen((RemoteMessage message) {
        debugPrint('Worker foreground push received: ${message.messageId}');
      });
      _initialized = true;
    } catch (error) {
      debugPrint('Worker push initialization skipped: $error');
    }
  }
  ...
  Future<String?> getDeviceToken() async {
    try {
      ...
      debugPrint('Unable to read worker FCM token: $error');
      return null;
    }
  }
  ...
  Future<void> registerDeviceToken({
    ...
    try {
      ...
      debugPrint('Worker FCM token registration failed: $error');
    }
  }
